    ...
    items: [
      {
        ...
        description:
          ...
          active: preferences.ahorrosYbeneficios && preferences.ahorrosYbeneficios.noticias_institucionales,
      },
      {
        ...
        active:preferences.ahorrosYbeneficios && preferences.ahorrosYbeneficios.ahorros_y_promociones,
      },
      {
        ...
        description:
          ...
          active:preferences.ahorrosYbeneficios && preferences.ahorrosYbeneficios.capacitacion_y_becas,
      },
    ],
  };
    ...
    items: [
      {
        ...
        active: preferences.ofertasYseguros && preferences.ofertasYseguros.prestamos,
      ...
      },
      {
        ...
        description:
          ...
          category:"ofertasYseguros",
          subCategory:"seguros",
          active: preferences.ofertasYseguros && preferences.ofertasYseguros.seguros,
  ...
  const dropDown3: DropdownOptions = {
    ...
    items: [
      ...
      },
      {
        ...
        active: preferences.tuCuenta && preferences.tuCuenta.aviso_semanal_saldo,
      },
      {
        ...
        active: preferences.tuCuenta && preferences.tuCuenta.saldo_en_descubierto,
      },
      {
    ...
    items: [
      {
        ...
        subCategory:"novedades",
        active: preferences.pagoServicios && preferences.pagoServicios.novedades ,
      ...
      },
      {
        ...
        active: preferences.pagoServicios && preferences.pagoServicios.servicios_proximos_vencer ,
      },
      {
        ...
        active: preferences.pagoServicios && preferences.pagoServicios.estado_servicios_adheridos ,
      },
    ],
  };
    ...
    items: [
      {
        ...
        active: preferences.inversiones && preferences.inversiones.alternativas_inversion,
      },
      {
        ...
        active: preferences.inversiones && preferences.inversiones.aviso_vencimiento_plazofijo,
      },
      {
        title:
        ...
        active: preferences.inversiones && preferences.inversiones.operacion_titulos_y_valores,
      },
    ],
  };
    ...
    items: [
      {
        ...
        active: preferences.cheques && preferences.cheques.cheques_por_acreditarse,
      },
      {
